...
namespace Opm
{
                                  ...
                                  ResProp<3>& res_prop)
    {
        ...
        if (fileformat == "sintef_legacy") {
            ...
            bool turn_normals = param.getDefault<bool>("turn_normals", false);
            {
                ...
                grid.processEclipseFormat(&inputGrid, nullptr, periodic_extension, turn_normals, clip_z);
            }
                                         ...
                                         ResProp<3>& res_prop)
    {
        ...
        grid.processEclipseFormat(&eg, nullptr, periodic_extension, turn_normals, clip_z);
