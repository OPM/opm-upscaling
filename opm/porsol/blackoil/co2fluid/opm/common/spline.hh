...
public:
     ...
     *
     * \param x An Dune::array containing the \f$x\f$ values of the spline's sampling points
     * \param y An Dune::array containing the \f$y\f$ values of the spline's sampling points
     */
     ...
     * \brief Convenience constructor for a full spline
     *
     * \param points An Dune::array of \f$(x,y)\f$ tuples of the spline's sampling points
     */
...
public:
     ...
     * \brief Convenience constructor for a natural spline
     *
     * \param x An Dune::array containing the \f$x\f$ values of the spline's sampling points (must have a size() method)
     * \param y An Dune::array containing the \f$y\f$ values of the spline's sampling points (must have a size() method)
     */
     ...
     * \brief Convenience constructor for a natural spline
     *
     * \param points An Dune::array of \f$(x,y)\f$ tuples of the spline's sampling points (must have a size() method)
     */
     ...
     *
     * \param nSamples The number of sampling points (must be >= 2)
     * \param points An Dune::array containing the \f$x\f$ and \f$x\f$ values of the spline's sampling points
     * \param m0 The slope of the spline at \f$x_0\f$
     * \param m1 The slope of the spline at \f$x_n\f$
     */
    template <class PointArray>
...
public:
     ...
     *
     * \param nSamples The number of sampling points (must be >= 2)
     * \param x An Dune::array containing the \f$x\f$ values of the sampling points
     * \param y An Dune::array containing the \f$y\f$ values of the sampling points
     * \param m0 The slope of the spline at \f$x_0\f$
     * \param m1 The slope of the spline at \f$x_1\f$
     */
    template <class ScalarContainer>
    ...
    template <class PointArray>
    OPM_DEPRECATED // use setArrayOfPoints
     ...
     *
     * \param tuples An Dune::array of \f$(x,y)\f$ tuples of the spline's sampling points
     * \param m0 The slope of the spline at \f$x_0\f$
     * \param m1 The slope of the spline at \f$x_1\f$
     */
