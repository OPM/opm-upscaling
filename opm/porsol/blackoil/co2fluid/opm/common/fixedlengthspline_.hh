                           ...
                           FixedLengthSpline_<ScalarT, nSamples> >
{
    ...
    typedef Opm::BlockVector<Opm::FieldVector<Scalar, 1> > Dune::BlockVector;
...
public:
     ...
     * Dune::array must be of size 'numberSamples' at least. Also, the number of
