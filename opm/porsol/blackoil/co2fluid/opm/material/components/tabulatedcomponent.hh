 ...
 *                 Dune::arrays. This is quite useful for debugging
 *                 purposes.
 */
...
public:
                     ...
                     Scalar pressMin, Scalar pressMax, unsigned nPress)
    {
        ...
        // fill the temperature-pressure Dune::arrays
        for (unsigned iT = 0; iT < nTemp_; ++ iT) {
            ...
            // fill the temperature, pressure gas Dune::arrays
        ...
        // fill the temperature-density Dune::arrays
        for (unsigned iT = 0; iT < nTemp_; ++ iT) {
            Scalar temperature = iT * (tempMax_ - tempMin_)/(nTemp_ - 1) + tempMin_;
            ...
            // fill the temperature, density gas Dune::arrays
            ...
            // fill the temperature, density liquid Dune::arrays
            for (unsigned iRho = 0; iRho < nDensity_; ++ iRho) {
                Scalar density =
                    Scalar(iRho)/(nDensity_ - 1) *
