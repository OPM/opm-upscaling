...
public:
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::gasIsCompressible()"); }

    /*!
     * \brief Returns true iff the liquid phase is assumed to be compressible
     */
    static bool liquidIsCompressible()
    { OPM_THROW(Opm::NotImplemented, "Component::liquidIsCompressible()"); }

    /*!
     * \brief A human readable name for the component.
     */
    static const char *name()
    { OPM_THROW(Opm::NotImplemented, "Component::name()"); }

    /*!
     * \brief The molar mass in \f$\mathrm{[kg]}\f$ of the component.
     */
    static Scalar molarMass()
    { OPM_THROW(Opm::NotImplemented, "Component::molarMass()"); }

    /*!
     * \brief Returns the critical temperature in \f$\mathrm{[K]}\f$ of the component.
     */
    static Scalar criticalTemperature()
    { OPM_THROW(Opm::NotImplemented, "Component::criticalTemperature()"); }

    /*!
     * \brief Returns the critical pressure in \f$\mathrm{[Pa]}\f$ of the component.
     */
    static Scalar criticalPressure()
    { OPM_THROW(Opm::NotImplemented, "Component::criticalPressure()"); }

    /*!
     * \brief Returns the temperature in \f$\mathrm{[K]}\f$ at the component's triple point.
     */
    static Scalar tripleTemperature()
    { OPM_THROW(Opm::NotImplemented, "Component::tripleTemperature()"); }

    /*!
     * \brief Returns the pressure in \f$\mathrm{[Pa]}\f$ at the component's triple point.
     */
    static Scalar triplePressure()
    { OPM_THROW(Opm::NotImplemented, "Component::triplePressure()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::vaporPressure()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::density()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::gasEnthalpy()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::liquidEnthalpy()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::gasInternalEnergy()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::liquidInternalEnergy()"); }
    ...
    { OPM_THROW(Opm::NotImplemented, "Component::gasViscosity()"); }
