 ...
 *        pure water.
 */
#ifndef OPM_SIMPLE_DNAPL_HH
#define OPM_SIMPLE_DNAPL_HH
...
public:
    ...
    {
        OPM_THROW(Opm::NotImplemented, "criticalTemperature for TCE");
    };
    ...
    {
        OPM_THROW(Opm::NotImplemented, "criticalPressure for TCE");
    };
    ...
    {
        OPM_THROW(Opm::NotImplemented, "tripleTemperature for TCE");
    };
    ...
    {
        OPM_THROW(Opm::NotImplemented, "triplePressure for TCE");
    };
