...
public:
                      ...
                      bool setInternalEnergy)
    {
        ...
        // mole fractions
        Opm::FieldMatrix<Scalar, numComponents*numPhases, numComponents*numPhases> M(0.0);
        Opm::FieldVector<Scalar, numComponents*numPhases> x(0.0);
        Opm::FieldVector<Scalar, numComponents*numPhases> b(0.0);
