...
public:
    typedef Opm::FieldVector<Scalar, numComponents> ComponentVector;
                      ...
                      const ComponentVector &targetFug)
    {
        ...
        Opm::FMatrixPrecision<Scalar>::set_singular_limit(1e-25);

        // save initial composition in case something goes wrong
        Opm::FieldVector<Scalar, numComponents> xInit;
        for (int i = 0; i < numComponents; ++i) {
        ...
        // Jacobian matrix
        Opm::FieldMatrix<Scalar, numComponents, numComponents> J;
        // solution, i.e. phase composition
        Opm::FieldVector<Scalar, numComponents> x;
        // right hand side
        Opm::FieldVector<Scalar, numComponents> b;
...
protected:
    ...
    template <class FluidState>
    static void linearize_(Opm::FieldMatrix<Scalar, numComponents, numComponents> &J,
                           Opm::FieldVector<Scalar, numComponents> &defect,
    ...
    static Scalar update_(FluidState &fluidState,
                          ...
                          Opm::FieldVector<Scalar, numComponents> &b,
                          int phaseIdx,
                          const Opm::FieldVector<Scalar, numComponents> &targetFug)
    {
        // store original composition and calculate relative error
        Opm::FieldVector<Scalar, numComponents> origComp;
        Scalar relError = 0;
        Scalar sumDelta = 0;
        Scalar sumx = 0;
        for (int i = 0; i < numComponents; ++i) {
