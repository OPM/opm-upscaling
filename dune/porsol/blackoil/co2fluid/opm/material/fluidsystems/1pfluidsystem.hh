...
public:
    ...
    static Scalar diffusionCoefficient(const FluidState &fluidState,
                                       ...
                                       int compIdx)
    {
        OPM_THROW(Opm::InvalidStateException, "Not applicable: Diffusion coefficients");
    };
    ...
    {
        OPM_THROW(Opm::InvalidStateException, "Not applicable: Binary diffusion coefficients");
    };
 ...
 *
 * This is an adapter to use Opm::TwoPImmiscible<TypeTag>, as is
