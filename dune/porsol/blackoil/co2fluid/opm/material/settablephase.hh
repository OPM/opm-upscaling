 ...
 */
#ifndef OPM_SETTABLE_PHASE_HH
#define OPM_SETTABLE_PHASE_HH

#include <dune/porsol/blackoil/co2fluid/opm/common/fmatrix.hh>
...
public:
    ...
    void XTox()
    {
        typedef Opm::FieldMatrix<Scalar, numComponents, numComponents> Matrix;
        typedef Opm::FieldVector<Scalar, numComponents> Vector;
