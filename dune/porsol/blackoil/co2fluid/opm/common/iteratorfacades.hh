// $Id$
#ifndef OPM_ITERATORFACADES_HH
#define OPM_ITERATORFACADES_HH
#include<iterator>
...
namespace Opm
{
  /*! \defgroup IteratorFacades Iterator facades 
   ...
   \brief Iterator facades for writing stl conformant iterators.
    ...
    class TestIterator : public Opm::BidirectionalIteratorFacade<TestIterator<C,T>,T, T&, int>
    {
  ...
  \endcode
  See opm/common/test/iteratorbase.hh for details.
  */
