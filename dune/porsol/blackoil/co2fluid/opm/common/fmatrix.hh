...
// $Id$
#ifndef OPM_FMATRIX_HH
#define OPM_FMATRIX_HH
...
#include <dune/porsol/blackoil/co2fluid/opm/common/densematrix.hh>
...
*/
  ...
  struct DenseMatVecTraits< FieldMatrix<K,ROWS,COLS> >
  {
    ...
    typedef Opm::array<row_type,ROWS> container_type;
  ...
  */
  ...
  {
    Opm::array< FieldVector<K,COLS>, ROWS > _data;
...
#else
using Opm::DenseMatrixHelp::multAssign;
#endif
