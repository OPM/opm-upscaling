...
void harmonicMeanMatrix(Opm::FieldMatrix<Scalar, m, n> &K,
                        const Opm::FieldMatrix<Scalar, m, n> &Ki,
                        const Opm::FieldMatrix<Scalar, m, n> &Kj)
{
...
bool isLarger(const Opm::FieldVector<Scalar, dim> &pos,
              const Opm::FieldVector<Scalar, dim> &smallerVec)
{
    for (int i=0; i < dim; i++)
    {
 ...
 */
template <class Scalar, int dim>
bool isSmaller(const Opm::FieldVector<Scalar, dim> &pos,
               const Opm::FieldVector<Scalar, dim> &largerVec)
{
    for (int i=0; i < dim; i++)
    {
 ...
 */
template <class Scalar, int dim>
bool isBetween(const Opm::FieldVector<Scalar, dim> &pos,
              const Opm::FieldVector<Scalar, dim> &smallerVec,
              const Opm::FieldVector<Scalar, dim> &largerVec)
{
