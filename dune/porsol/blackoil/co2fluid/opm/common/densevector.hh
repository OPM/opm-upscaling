...
#ifndef OPM_DENSEVECTOR_HH
#define OPM_DENSEVECTOR_HH
 ...
 */
  ...
  class DenseIterator : 
    public Opm::RandomAccessIteratorFacade<DenseIterator<C,T>,T, T&, std::ptrdiff_t>
  {
