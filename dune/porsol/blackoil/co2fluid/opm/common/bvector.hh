...
#ifndef OPM_BVECTOR_HH
#define OPM_BVECTOR_HH
...
namespace Opm {
  ...
  */
  ...
  public:
	...
	block_vector_unmanaged& operator+= (const block_vector_unmanaged& y)
	{
	  ...
	  if (this->n!=y.N()) OPM_THROW(ISTLError,"vector size mismatch");
#endif
  ...
  */
  ...
  public:
	...
	BlockVectorWindow& operator= (const BlockVectorWindow& a)
	{
	  // check correct size
#ifdef OPM_ISTL_WITH_CHECKING
	  if (this->n!=a.N()) OPM_THROW(ISTLError,"vector size mismatch");
#endif
  ...
  */
  ...
  public:
	...
	{
#ifdef OPM_ISTL_WITH_CHECKING
	  if (!includesindexset(y)) OPM_THROW(ISTLError,"index set mismatch");
#endif
    ...
    field_type operator* (const compressed_block_vector_unmanaged& y) const
	{
	  ...
	  if (!includesindexset(y) || !y.includesindexset(*this) )
	    OPM_THROW(ISTLError,"index set mismatch");
#endif
	  field_type sum=0;
	  for (size_type i=0; i<this->n; ++i) 
