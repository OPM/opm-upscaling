  ...
  refCnt  ( NULL )
{
   if ( arrSize > 0 ) {
      ...
      //c //TEST_ASSERT(data[0] == T(), " default array element "<<data[0]<<" "<<T(),ERROR);
      data[0] = T();
      //c //TEST_ASSERT(data[0] == T(), " default array element assigned",ERROR);
...
//
//  DESCRIPTION:
//    Get one single element from array. Indexing from 0 - n-1 for array
//    size of n elements.
//
//  RETURNS:
//
...
//
//  DESCRIPTION:
//    The routine requires that elem appears in the array.  
//     In that case it returns the last postion in the array where elem occurs
//  RETURNS: the last postion in the array where elem occurs.
//
//  NOTE:
//
//  EXAMPLE:
...
//
//  DESCRIPTION:
//    Append the element "el" after the last element of this array.
//
//  RETURNS:
//
//  NOTE:
...
//
//  DESCRIPTION:
//    Concats another array at the end of this object. This object will
...
//
//  EXAMPLE:
//    Array<int> a1;       // Instanciate empty array
//    a1 = copy(a1, 10);   // Preset the array size to 10 int
//
//
//-----------------------------------------------------------------------------
template <class T>
