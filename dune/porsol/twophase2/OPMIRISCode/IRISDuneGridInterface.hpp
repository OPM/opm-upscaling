...
*/
  ...
  */
  ...
  std::vector<int> numbOfEdgesAtSubBoundary_;//NOTE: The length of this array is obviously: numbSubBoundaries_;
  std::vector<EdgePointer> EdgesAtSubBoundary0_;//NOTE: The length of this array is obviously: numbOfEdgesAtSubBoundary_[0];
  std::vector<EdgePointer> EdgesAtSubBoundary1_;//NOTE: The length of this array is obviously: numbOfEdgesAtSubBoundary_[1];
  std::vector<EdgePointer> EdgesAtSubBoundary2_;//NOTE: The length of this array is obviously: numbOfEdgesAtSubBoundary_[2];
  std::vector<EdgePointer> EdgesAtSubBoundary3_;//NOTE: The length of this array is obviously: numbOfEdgesAtSubBoundary_[3];
  std::vector<EdgePointer> EdgesAtSubBoundary4_;//NOTE: Length=0 in 2D, else length of this array is obviously: numbOfEdgesAtSubBoundary_[4];
  std::vector<EdgePointer> EdgesAtSubBoundary5_;//NOTE: Length=0 in 2D, else length of this array is obviously: numbOfEdgesAtSubBoundary_[5];
  */
