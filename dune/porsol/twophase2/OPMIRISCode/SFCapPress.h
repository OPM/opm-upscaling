...
//Boolean DI_0u() const ;
  ...
  */
  ...
  /*
    ...
    We use a 1D array repr., where the outer imaginary row has a length of m_RowLength !!
    The first index in the imaginary "double array" repreresents the actual rock type.
